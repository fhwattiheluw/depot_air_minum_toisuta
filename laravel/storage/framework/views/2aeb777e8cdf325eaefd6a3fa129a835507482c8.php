          ...
          <table class="table align-items-center mb-0">
            ...
            <tbody>
              ...
              <tr class="text-center">
                <td>
                  <p class="text-xs font-weight-bold mb-0"><?php echo e($item->nama_item); ?></p>
                </td>
                <td>
                ...
                <td>
                  <p class="text-xs font-weight-bold mb-0"><?php echo e($item->jumlah * $item->harga_satuan); ?></p>
                </td>
                <td>
                  <p class="text-xs font-weight-bold mb-0"><?php echo e($item->keterangan); ?></p>
                </td>
                <td>
...
<?php echo $__env->make('layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fadli h wattiheluw\Documents\PROJEK\depot_air_minum_toisuta\laravel\resources\views/rekapan_detail_pengeluaran.blade.php ENDPATH**/ ?>