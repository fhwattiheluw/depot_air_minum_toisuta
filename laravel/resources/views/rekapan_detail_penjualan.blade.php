          ...
          <table class="table align-items-center mb-0">
            ...
            <tbody>
              ...
              <tr class="text-center">
                <td>
                  <p class="text-xs font-weight-bold mb-0">{{$item->nama_kostumer}}</p>
                </td>
                <td>
                  <p class="text-xs font-weight-bold mb-0">{{$item->tipe_penjualan}}</p>
                </td>
                <td>
                  <p class="text-xs font-weight-bold mb-0">{{$item->pembayaran}}</p>
                </td>
                <td>
